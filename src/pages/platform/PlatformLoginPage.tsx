...
export default function PlatformLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      platformAuthStore.setAuth(token, admin)
      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <p className="text-sidebar-text text-xs">Platform Admin</p>
          </div>
        </div>

        <div className="bg-white rounded-xl p-6 shadow-2xl">
          <h2 className="text-gray-900 font-semibold text-base mb-1">Sign in</h2>
          <p className="text-gray-500 text-xs mb-5">Onboard and manage client companies</p>
          ...
          <p className="mt-4 text-center text-xs text-gray-400">
            This is a separate login from client staff and customer portal accounts.
          </p>
        </div>
      </div>
    </div>
